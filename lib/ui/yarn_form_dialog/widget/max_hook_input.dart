...
Widget maxHookInput(YarnFormDialogModelAbstart model) {
  return TextFormField(
    keyboardType: TextInputType.numberWithOptions(),
    decoration: InputDecoration(label: Text("Max hook")),
    initialValue: model.fill ? model.base.maxHook.toStringAsFixed(2) : null,
    ...
    onSaved: (newValue) {
      ...
      model.base.maxHook = double.parse(newValue);
    },
